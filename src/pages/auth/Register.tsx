...
const Register: React.FC = () => {
  ...
  const validateForm = (): boolean => {
    ...
    if (!formData.email.trim()) {
      ...
      !formData.email.includes("tce.edu")
    ) {
      newErrors.email =
        "Email must be from tce.edu domain (e.g., name@tce.edu or name@student.tce.edu)";
    }
    ...
    try {
      ...
      if (!isRegimentalUnique)
        uniqueErrors.regimentalNumber =
          "This Regimental Number is already in use by another cadet";
      if (!isRegisterUnique)
        uniqueErrors.registerNumber =
          "This Register Number is already in use by another cadet";
      if (!isRollUnique)
        uniqueErrors.rollNo =
          "This Roll Number is already in use by another cadet";
            ...
            <Card.Body className="p-4 p-md-5">
              ...
              <Form onSubmit={handleSubmit} noValidate>
                ...
                <Row className="g-3">
                  <Col xs={12} md={4}>
                    <Form.Group className="mb-3" controlId="regimentalNumber">
                      <Form.Label>
                        Regimental Number <span className="text-danger">*</span>
                      </Form.Label>
                      <Form.Control
                        type="text"
                ...
                <Alert variant="info" className="mt-3 mb-0">
                  ...
                  After submitting, a verification email will be sent to your
                  email address. Please verify your email (check Spam/Junk
                  folder too), then wait for senior's approval.
                </Alert>
              </Form>
