      ...
      <Container className="py-5">
        <div className="text-center">
          ...
          <p className="text-muted">
            There are no open recruitment drives at the moment. Please check
            back later or contact the NCC office for details.
          </p>
        </div>
      </Container>
    );
  ...
  return (
    <div>
      ...
      <div
        style={{
          background:
            "linear-gradient(135deg, #0a1628 0%, #0d2b5e 50%, #14396d 100%)",
          color: "#fff",
              ...
              >
                <Card.Body className="p-4 p-md-5 d-flex flex-column align-items-center">
                  ...
                  <p className="text-muted small mb-4">
                    Army Wing — Senior Division training programme for male
                  ...
                  {settings?.sdFormUrl ? (
                    ...
                    <Alert
                      variant="info"
                      className="mt-auto mb-0 w-100 text-center"
                    >
                      <i className="bi bi-info-circle me-1" />
                      Recruitment form not available yet. Contact the NCC
                      office.
                    </Alert>
                  )}
                </Card.Body>
            ...
            <AnimatedSection effect="slide" delay={0.2}>
              ...
              >
                <Card.Body className="p-4 p-md-5 d-flex flex-column align-items-center">
                  ...
                  <p className="text-muted small mb-4">
                    Army Wing — Senior Wing training programme for female
                    students enrolled in colleges/universities.
                  </p>
                  {settings?.swFormUrl ? (
                    <Button
