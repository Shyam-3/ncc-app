      ...
      if (data?.anoUids && data.anoUids.length > 0) {
        try {
          const profiles = await Promise.all(
            data.anoUids.map((uid) =>
              getDoc(firestoreDoc(db, "users", uid)).then((snap) =>
        ...
        <Card className="border-0 shadow-sm">
          <Card.Body>
            ...
            <div className="mb-0 text-muted about-section-body">
              {getSectionBody("About Our Unit") ||
                "Information about our NCC unit will be displayed here."}
            </div>
          </Card.Body>
        </Card>
      </div>
      ...
      <Accordion defaultActiveKey="0" className="shadow-sm">
        <Accordion.Item eventKey="0">
          ...
          <Accordion.Body>
            ...
            <div className="mb-0 text-muted about-section-body">
              {getSectionBody("ANO/CTO & Staff") ||
                "Details about the ANO/CTO and staff members."}
            </div>
          </Accordion.Body>
        </Accordion.Item>
        ...
        <Accordion.Item eventKey="1">
          ...
          <Accordion.Body>
            <div className="mb-0 text-muted about-section-body">
              {getSectionBody("NCC Motto & Song") ||
                "Unity and Discipline. The NCC song details will be updated here."}
            </div>
          </Accordion.Body>
        </Accordion.Item>
        ...
        <Accordion.Item eventKey="2">
          ...
          <Accordion.Body>
            <div className="mb-0 text-muted about-section-body">
              {getSectionBody("Organizational Structure") ||
                "The organizational structure of our unit."}
            </div>
          </Accordion.Body>
        </Accordion.Item>
      </Accordion>
