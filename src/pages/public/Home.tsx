...
const Home: React.FC = () => {
  ...
  useEffect(() => {
    const fetchAnnouncements = currentUser
      ? listAnnouncementsForUser()
      : listPublicAnnouncements();

    fetchAnnouncements
      .then((all) => {
        const important = all.filter((a) =>
          ["recruitment", "celebrations"].includes(a.category),
        );
        const classic = all.filter(
          (a) => !["recruitment", "celebrations"].includes(a.category),
        );
    ...
    <div>
      ...
      <Carousel fade interval={3000} indicators>
        <Carousel.Item>
          ...
          <Carousel.Caption className="text-start">
            ...
            <p className="lead mb-3 mb-md-4 d-none d-sm-block">
              Unity and Discipline — shaping future leaders.
            </p>
            <div>
              <Button
                as={Link}
        ...
        <Carousel.Item>
          ...
          />
          <Carousel.Caption className="text-start">
            <h2 className="fw-semibold d-none d-md-block">
              Community & Social Service
            </h2>
            <h4 className="fw-semibold d-block d-md-none">
              Community & Social Service
            </h4>
            <p className="mb-3 mb-md-4 d-none d-sm-block">
              Serve society through drives, awareness camps, and outreach.
            </p>
            <Button
              as={Link}
        ...
        <Carousel.Item>
          ...
          <Carousel.Caption className="text-start">
            ...
            <p className="mb-3 mb-md-4 d-none d-sm-block">
              Build confidence with drills, treks, and leadership exercises.
            </p>
            <Button
              as={Link}
              to="/activities/camps"
        ...
        <div className="d-flex flex-column">
          {importantAnnouncements.map((ann, idx) => {
            ...
            if (isCelebration) {
              bannerClass =
                ann.theme === "ncc"
                  ? "home-celebration-ncc-banner"
                  : "home-celebration-tricolor-banner";
            }
                ...
                <div className={bannerClass}>
                  <Container>
                    <Row className="align-items-center justify-content-center text-center text-md-start">
                      <Col md={8} lg={7}>
                        <h2 className="home-recruitment-title">{ann.title}</h2>
                        <p className="home-recruitment-body">{ann.body}</p>
          ...
          <Col xs={12} sm={6} md={4} lg={4} xl={4}>
            <Card className="h-100 text-center border-0 shadow-sm hover-lift">
              <Card.Body>
                ...
                <Card.Text>
                  Participate in training camps, national celebrations, and
          ...
          <Col xs={12} sm={6} md={4} lg={4} xl={4}>
            <Card className="h-100 text-center border-0 shadow-sm hover-lift">
              <Card.Body>
                ...
                <Card.Text>
                  Modern digital attendance system with real-time monitoring and
                  reports.
                </Card.Text>
              </Card.Body>
            </Card>
          ...
          <Col xs={12} sm={6} md={4} lg={4} xl={4}>
            <Card className="h-100 text-center border-0 shadow-sm hover-lift">
              <Card.Body>
                ...
                <Card.Text>
                  Track your progress, earn certificates, and showcase your NCC
                  achievements.
                </Card.Text>
              </Card.Body>
            </Card>
          ...
          <Col xs={12} sm={6} md={4} lg={4} xl={4}>
            <Card className="h-100 text-center border-0 shadow-sm hover-lift">
              <Card.Body>
                ...
                <Card.Text>
                  Access study materials, practice tests, and resources for B &
                  C certificate exams.
                </Card.Text>
              </Card.Body>
            </Card>
          ...
          <Col xs={12} sm={6} md={4} lg={4} xl={4}>
            <Card className="h-100 text-center border-0 shadow-sm hover-lift">
              <Card.Body>
                ...
                <Card.Text>
                  Connect with alumni, get mentorship, and explore career
                  opportunities.
                </Card.Text>
              </Card.Body>
            </Card>
          ...
          <Col xs={12} sm={6} md={4} lg={4} xl={4}>
            <Card className="h-100 text-center border-0 shadow-sm hover-lift">
              <Card.Body>
                ...
                <Card.Text>
                  Browse photos and videos from camps, parades, and special
                  events.
                </Card.Text>
              </Card.Body>
            </Card>
        ...
        <Container>
          <AnimatedSection effect="fade" delay={0.05}>
            ...
            <p className="text-center text-muted mb-4">
              Stay informed about upcoming events, camps, and activities
            </p>
          </AnimatedSection>
          ...
          {latestAnnouncements.length > 0 ? (
                    ...
                    <Card className="h-100 border-0 shadow-sm hover-lift home-announcement-card">
                      <Card.Body className="d-flex flex-column">
                        <div className="mb-2">
                          <Badge
                            bg={
                              ANNOUNCEMENT_CATEGORY_COLORS[ann.category] ||
                              "secondary"
                            }
                          >
            ...
            <div className="text-center py-4 bg-white rounded shadow-sm border border-light">
              <i
                className="bi bi-bell-slash text-muted mb-2"
                style={{ fontSize: "2.5rem" }}
              ></i>
              <h5 className="text-muted mt-2">No active announcements</h5>
              <p className="text-muted mb-0 small">
                Check back later for updates on camps and activities.
              </p>
            </div>
          )}
        </Container>
      ...
      >
        ...
        <p className="lead mb-4">
          Become part of India's largest youth organization and develop
