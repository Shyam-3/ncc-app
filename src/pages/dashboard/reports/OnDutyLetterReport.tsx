            ...
            <Card.Body>
              ...
              <div className="table-responsive od-cadet-table-wrap">
                <Table striped hover size="sm" className="mb-0">
                  <thead className="od-cadet-table-head">
                    <tr>
...
const OnDutyLetterPreview: React.FC<PreviewProps> = ({ show, onHide, formData, headerTemplate, template, cadets }) => {
  ...
  return (
    <Modal show={show} onHide={onHide} size="xl" fullscreen="lg-down" className="od-preview-modal">
      ...
      <Modal.Body className="od-preview-body">
        <style>{`
          @media print {
            @page {
              size: A4;
        ...
        <div id="print-content" className="od-print-content">
          <div className="od-page od-page-letter">
            <div className="od-markdown-header">
              <Markdown content={renderedHeader} />
            </div>

            <div className="od-markdown-letter">
          ...
          {pagedDepartmentRows.map((rows, pageIndex) => {
            return (
              <div key={pageIndex} className="od-page od-page-list">
                <div className="od-list-title">ON-DUTY CADET LIST</div>
                <div className="od-list-page-count">
                  Page {pageIndex + 1} of {totalPages}
                </div>

                <table className="od-list-table">
                  <thead>
                    <tr>
                      <th className="od-th od-th-sno">S.NO</th>
