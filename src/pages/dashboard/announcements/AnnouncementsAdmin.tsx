...
const ALL_CATEGORIES = Object.values(
  ANNOUNCEMENT_CATEGORIES,
) as AnnouncementCategory[];
const ALL_VISIBILITIES = Object.values(
  ANNOUNCEMENT_VISIBILITY,
) as AnnouncementVisibility[];
...
const AnnouncementsAdmin: React.FC = () => {
  ...
  const [visibility, setVisibility] =
    useState<AnnouncementVisibility>("public");
  ...
  const loadAnnouncements = useCallback(async () => {
    try {
      ...
      if (deletePromises.length > 0) {
        ...
        toast.success(
          `Auto-deleted ${deletePromises.length} expired announcement(s)`,
        );
      }
  ...
  return (
    <Container className="py-5 announcements-admin">
        ...
        <Card.Body>
          ...
          <div className="d-flex flex-wrap gap-3 mb-4">
            ...
            <div className="visibility-filter-pills">
              <span className="me-2 fw-semibold small text-muted">
                Visibility:
              </span>
              <Button
                size="sm"
              ...
              <Button
                size="sm"
                variant={
                  visibilityFilter === "public" ? "success" : "outline-success"
                }
                className="filter-pill"
                  ...
                  {filteredItems.map((item) => {
                    ...
                    return (
                      <React.Fragment key={id}>
                        <tr
                          className={
                            expired ? "table-secondary opacity-75" : ""
                          }
                        >
                          ...
                          <td>
                            <Badge
                              bg={ANNOUNCEMENT_CATEGORY_COLORS[item.category]}
                            >
                  ...
                  <div className="d-flex flex-wrap gap-2">
                    {group.readers.map((r, rIdx) => (
                      ...
                      >
                        ...
                        >
                          {r.readAt?.toDate
                            ? formatISTDateTime(r.readAt.toDate())
                            : ""}
                        </span>
                      </Badge>
                    ))}
      ...
      >
        <Modal.Header closeButton>
          <Modal.Title>
            {editingId ? "Confirm Update" : "Confirm Create"}
          </Modal.Title>
        </Modal.Header>
        <Modal.Body>
