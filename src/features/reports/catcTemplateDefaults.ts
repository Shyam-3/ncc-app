...
export const CATC_PAGE_LABELS: Record<keyof CatcCampTemplateData['pages'], string> = {
...
export const DEFAULT_CATC_CAMP_TEMPLATE: CatcCampTemplateData = {
  ...
  pages: {
    page1: {
      ...
      note:
        'Most Important of Signature for Govt Medical Doctor Only. Round Office Stamp must to be on Left Side Signature of Doctor.',
...
export function mergeCatcCampTemplate(partial: Partial<CatcCampTemplateData>): CatcCampTemplateData {
  ...
  if (partial.countersignStation) base.countersignStation = partial.countersignStation;
  if (partial.defaultCampLocation) base.defaultCampLocation = partial.defaultCampLocation;
