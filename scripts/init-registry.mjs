...
async function initRegistry() {
  ...
  console.log(`Found ${usersSnapshot.docs.length} users and ${pendingSnapshot.docs.length} pending cadets.`);
  ...
  await commitBatch();
  console.log(`Initialization complete. Added ${totalAdded} numbers to the registry.`);
}
